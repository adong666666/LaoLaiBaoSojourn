...
extension ZYPlayer {
    ...
    fileprivate func addNotificationObserver() {
        // 监听屏幕旋转的通知
        //NotificationCenter.default.addObserver(self,selector: #selector(self.screenDidRotate(note:)),
                //name: NSNotification.Name.UIDeviceOrientationDidChange, object: nil)
        NotificationCenter.default.addObserver(self,selector: #selector(self.screenDidRotate(note:)),
                name: NSNotification.Name.AVCaptureDeviceSubjectAreaDidChange, object: nil)
        // 监听app 进入后台 返回前台的通知
        //NotificationCenter.default.addObserver(self, selector: #selector(self.appDidEnterBackground),
                //name: NSNotification.Name.UIApplicationWillResignActive, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(self.appDidEnterBackground),
                name: NSNotification.Name.NSExtensionHostWillResignActive, object: nil)
       // NotificationCenter.default.addObserver(self, selector: #selector(self.appDidEnterPlayGround),
               // name: NSNotification.Name.UIApplicationDidBecomeActive, object: self)
        NotificationCenter.default.addObserver(self, selector: #selector(self.appDidEnterBackground), name: NSNotification.Name.NSExtensionHostDidBecomeActive, object: self)
        // 监听 playerItem 的状态通知
