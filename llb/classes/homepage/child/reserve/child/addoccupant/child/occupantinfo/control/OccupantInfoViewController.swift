...
class occupantinfoViewController: UIViewController,UITextFieldDelegate {
    ...
    var btn: PowerButton = {
        ...
        bt1.addTarget(self, action: #selector(occupantinfoViewController.buttonTap(_:)), for: UIControl.Event.touchUpInside)
        return bt1
    }()
    var btn2: PowerButton = {
        ...
        bt1.setTitleColor(UIColor.init(r: 38, g: 202, b: 203), for: UIControl.State())
        bt1.addTarget(self, action: #selector(occupantinfoViewController.buttonTap2(_:)), for: UIControl.Event.touchUpInside)
        return bt1
    }()
    var btn3: PowerButton = {
        ...
        bt1.setTitle("", for: UIControl.State())
        bt1.setTitleColor(UIColor.init(r: 38, g: 202, b: 203), for: UIControl.State())
        bt1.addTarget(self, action: #selector(occupantinfoViewController.buttonTap3(_:)), for: UIControl.Event.touchUpInside)
        return bt1
    }()
    ...
    var llabel9: PatientInfoCustomLabel = {
        ...
        label.textColor = UIColor.init(r: 250, g: 250, b: 250)
        label.textAlignment = .center
        return label
    }()
    ...
    var ttextField: PowertextField = {
        ...
        textField.attributedPlaceholder = NSAttributedString.init(string: "请确保信息属实", attributes:
            [kCTForegroundColorAttributeName as NSAttributedString.Key: UIColor.lightGray])
