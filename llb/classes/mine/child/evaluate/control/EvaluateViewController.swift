...
class evaluateViewController: UIViewController {
    ...
    fileprivate lazy var tableView : UITableView = {[unowned self] in
        ...
        tableView.register(evaluateTableViewCell.self, forCellReuseIdentifier: CellID)
...
extension evaluateViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: CellID) as! evaluateTableViewCell
        cell.awakeFromNib()
